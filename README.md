...
## インストール
**GitHub**  
[![インストールボタン](images/install_button.png "クリックでアドオンをインストール")](https://github.com/akoya-tomo/koshian_catalog_marker_kai/releases/download/v2.4.0/koshian_catalog_marker_kai-2.4.0-fx.xpi)
...
* ![\(New\)](images/new.png "New") 新レイアウトだと「カタログの古順から取得」で古いスレをマークしない。  
  - 新レイアウトでは「板の最新レスNo.を取得して保存数から算出」を有効にしてください。  
